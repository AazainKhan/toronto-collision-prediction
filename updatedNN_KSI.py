...
# Evaluate the model
y_train_pred = mlp.predict(x_train_prepared)
y_test_pred = mlp.predict(x_test_prepared)
...
print("Recall score accuracy: ", recall_score(y_test, y_test_pred, pos_label='Fatal'))
print("Precision score accuracy: ", precision_score(y_test, y_test_pred, pos_label='Fatal'))
